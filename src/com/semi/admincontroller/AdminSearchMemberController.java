...
/**
 * Servlet implementation class AdminSearchMemberController
 */
@WebServlet("/search.ad")
public class AdminSearchMemberController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminSearchMemberController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new MemberService().selectMemberCount(keyword);
		...
		ArrayList<Member> list = new MemberService().selectMemberList(pi, keyword, category);
