...
/**
 * Servlet implementation class AdminDeliverPageController
 */
@WebServlet("/deliver.ad")
public class AdminDeliverPageController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminDeliverPageController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new DeliveryService().selectListCount();
		...
		request.getRequestDispatcher("views/7H_The_Town/adminPage/AdminPageDelivery.jsp").forward(request, response);
	}
