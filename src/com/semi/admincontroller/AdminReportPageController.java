...
/**
 * Servlet implementation class AdminReportPageController
 */
@WebServlet("/report.ad")
public class AdminReportPageController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminReportPageController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new BoardService().selectListCountReport();
		...
		ArrayList<Report> list = new BoardService().reportList(pi);
