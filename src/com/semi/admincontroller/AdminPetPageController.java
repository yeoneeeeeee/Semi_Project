...
/**
 * Servlet implementation class AdminPetPageController
 */
@WebServlet("/pet.ad")
public class AdminPetPageController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminPetPageController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/views/7H_The_Town/adminPage/AdminPagePetControll.jsp").forward(request, response);
	}
