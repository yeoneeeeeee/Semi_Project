...
/**
 * Servlet implementation class AdminSearchReportController
 */
@WebServlet("/searchreport.ad")
public class AdminSearchReportController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminSearchReportController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new ReportService().selectReportCount(keyword);
		...
		ArrayList<Report> list = new ReportService().selectReportList(pi, keyword, category);
		...
		request.getRequestDispatcher("views/7H_The_Town/adminPage/AdminPageClientReport.jsp").forward(request, response);
