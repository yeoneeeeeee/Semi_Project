...
/**
 * Servlet implementation class AdminSearchFaqController
 */
@WebServlet("/searchfaq.ad")
public class AdminSearchFaqController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminSearchFaqController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		listCount = new FaqService().selectFaqCount(keyword);
		...
		ArrayList<Faq> list = new FaqService().selectFaqList(pi, keyword, category);
		...
		request.getRequestDispatcher("views/7H_The_Town/adminPage/AdminPageClientCenter.jsp").forward(request, response);
