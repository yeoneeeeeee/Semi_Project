...
/**
 * Servlet implementation class AdminClientPageController
 */
@WebServlet("/client.ad")
public class AdminClientPageController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminClientPageController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Faq> list = new FaqService().faqList(pi);
