...
/**
 * Servlet implementation class MemberAdoptController
 */
@WebServlet("/adopt.me")
public class MemberAdoptController extends HttpServlet {
   private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MemberAdoptController() {
        super();
   ...
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      listCount = new DeliveryService().selectListCount(loginUser.getUserNo());
      ...
      request.setAttribute("dList", dList);
         ...
         request.getRequestDispatcher("/views/7H_The_Town/mypage/MyPageAdopt.jsp").forward(request, response);
      } else {
