 ...
 */
@WebServlet("/UserFaqDelete.bo")
public class UserFaqPostDeleteController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UserFaqPostDeleteController() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(result > 0) {
			...
			response.sendRedirect(request.getContextPath()+"/inquiry.me");				
		}else{
