 ...
 */
@WebServlet("/post.bo")
public class PostingPostController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PostingPostController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(loginUser != null) {			
			request.getRequestDispatcher("views/7H_The_Town/board/PostionPage.jsp").forward(request, response);
		}else {
