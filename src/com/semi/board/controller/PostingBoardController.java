 ...
 */
@WebServlet("/list.bo")
public class PostingBoardController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("views/7H_The_Town/board/PostionPage_board.jsp").forward(request, response);
	}
