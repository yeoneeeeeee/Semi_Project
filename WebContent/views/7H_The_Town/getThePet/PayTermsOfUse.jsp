<%@ page import="com.semi.board.model.vo.GetThePet" %>
...
<head>
    ...
    <title>7H THE TOWN | GetThePet 이용약관</title>
    ...
    <link rel="stylesheet" href="views/7H_The_Town/resource/CSS,JS/getThePet/PayTermsOfUse.css">
</head>
<body>
    ...
    <div class="termsOuter">
        <form class="termsForm  col s12 m2 z-depth-3" action="adopt.get">
            <h4>입양 신청 약관</h4>
            ...
            <div class="termsSubmit">
                <p><button type="submit">입양 신청</button></p>
            </div>
        </form>
    </div>
